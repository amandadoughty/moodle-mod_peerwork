...
$string['confirmunlockeditinggrader'] = 'The grades given by {$a} are currently locked. Would you like to unlock them and allow this student to change any of their grades or justifications?';
$string['confirmunlockeditingsubmission'] = 'Editing the submission is currently locked. Would you like to unlock it and allow students to update the submission?';
